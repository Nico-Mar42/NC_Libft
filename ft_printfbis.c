...
long	printpoint(char c, unsigned long d, int minlen)
{
	char	*hexa;
	char 	*temp;
	int		count;
...
int	printhexa(char c, unsigned int d, int minlen)
{
	char	*lower;
	char	*upper;
	char	*hexa;
...
int	printchar(char c, int minlen)
{
	int	i;
...
int	printusint(unsigned int d, int minlen)
{
	char	*rslt;
	int		len;
